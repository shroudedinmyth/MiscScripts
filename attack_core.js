...
var BattlerChecker = {
	...
	getBaseSecondary: function(unit) {
		var sec;
	...
	getRealBattleSecondary: function(unit) {
		//When wanting to execute the real battle with a different secondary from the original secondary, adjust with this method.
